...
public class BarangApiClient {
    private static final String BASE_URL = "http://localhost/TugasBesarPBO/application-tier/public/barang";
    ...
    public List<Barang> findAll() throws Exception {
        ...
        ApiResponse<List<Barang>> apiResp = gson.fromJson(response.body(),
                new TypeToken<ApiResponse<List<Barang>>>() {
                }.getType());
        if (!apiResp.success)
    ...
    public void create(Barang m) throws Exception {
    ...
    public void update(Barang m) throws Exception {
        var requestBody = new HashMap<String, Object>();
        requestBody.put("kategori", m.getKategori());
        requestBody.put("nama", m.getNama());
        requestBody.put("jumlah", m.getJumlah() != null ? m.getJumlah() : null);
